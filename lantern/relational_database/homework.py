...
def task_13_list_products_from_sweden_suppliers(cur):
    ...
    Returns: 3 records
    """
    cur.execute("SELECT productname FROM products, suppliers WHERE country = 'Sweden'"
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    Returns: 194 records
    """
    cur.execute("SELECT c.customername, c.address, c.country as customercountry, s.country as suppliercountry,"
                " s.suppliername FROM customers as c FULL JOIN suppliers as s ON s.country = c.country "
